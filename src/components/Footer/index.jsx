  ...
  <div className="container">
    ...
    <div className="row footer-links">
      ...
      <div className="col-sm-3 country-flag-sec">
        <h6>Popular Events</h6>
        <ul>
          <li><a href="http://www.kyazoonga.com.au/" target="_blank"><img src="assets/images/CountriesFlag/aus.png" />Australia</a></li>
          <li><a href="http://www.kyazoonga.com/" target="_blank"><img src="assets/images/CountriesFlag/ind.png" />India</a></li>
          <li><a href="http://www.kyazoonga.ie/" target="_blank"><img src="assets/images/CountriesFlag/ireland.png" />Ireland</a></li>
          <li><a href="http://www.kyazoonga.ae/" target="_blank"><img src="assets/images/CountriesFlag/uae.png" />United Arab Emirates</a></li>
          <li><a href="http://www.kyazoonga.com/" target="_blank"><img src="assets/images/CountriesFlag/usa.png" />United States</a></li>
        </ul>
      </div>
    </div>
    <div className="footer-social text-center">
      ...
      <ul>
        <li><a className="f" href="https://www.facebook.com/kyazoonga" target="blank" rel="me">
            <img src="assets/images/facebook.png" alt="Facebook" width={32} height={32} /></a></li>
        <li><a className="t" href="https://twitter.com/kyazoonga" target="blank" rel="me">
            <img src="assets/images/twitter.png" alt="Twitter" width={32} height={32} /></a></li>
        <li><a className="ig" href="https://www.instagram.com/kyazoonga/" target="blank" rel="me">
            <img src="assets/images/instagram.png" alt="in" width={32} height={32} /></a></li>
        <li><a className="sc" href="https://www.snapchat.com/add/kyazoonga" target="blank" rel="me">
            <img src="assets/images/snapchat.png" alt="in" width={32} height={32} /></a></li>
        <li><a className="in" href="https://www.linkedin.com/company/kyazoonga" target="blank" rel="me">
            <img src="assets/images/in.png" alt="Linkedin" width={32} height={32} /></a></li>
        <li><a className="yt" href="https://www.youtube.com/user/kyazoongachannel" target="blank" rel="me">
            <img src="assets/images/youtube.png" alt="Youtube" width={32} height={32} /></a></li>
        <li><a className="g" href="https://plus.google.com/+kyazoongachannel" target="blank" rel="me">
            <img src="assets/images/google.png" alt="Google Plus" width={32} height={32} /></a></li>
        <li><a className="p" href="https://www.pinterest.com/kyazoonga/" target="blank" rel="me">
            <img src="assets/images/pinterest.png" alt="Pinterest" width={32} height={32} /></a></li>
      </ul>
